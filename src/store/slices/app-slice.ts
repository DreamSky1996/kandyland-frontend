...
import { StakingContract, sKANDYTokenContract, KandyTokenContract } from "../../abi";
...
export const loadAppDetails = createAsyncThunk(
    ...
    async ({ networkID, provider }: ILoadAppDetails) => {
        ...
        const circSupply = (await sKANDYContract.circulatingSupply()) / Math.pow(10, 9);
        ...
        const circ = await sKANDYContract.circulatingSupply();
